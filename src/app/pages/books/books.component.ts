...
export class BooksComponent {
  ...
  constructor() {
    this.books = [
      ...
      //new Book("Viaje al Centro de la Tierra", "balnda", "Julio Verne", 19.99, "https://th.bing.com/th/id/OIP.hfKiqqxjHlLn09SByMiMBwHaKN?w=195&h=270&c=7&r=0&o=5&pid=1.7"),
      new Book("Dune", "balnda", "Frank Herbert", 29.99, "https://th.bing.com/th/id/OIP.cvoSdGRO8TtT-zw5N0qAAQHaLL?w=195&h=295&c=7&r=0&o=5&pid=1.7"),
